...
case "${RUN_PROFILE}" in
  ...
  counterfactual_gate)
    ...
    TASK_NAMES_OVERRIDE='[pick_up_the_black_bowl_next_to_the_plate_and_place_it_on_the_plate,pick_up_the_black_bowl_between_the_plate_and_the_ramekin_and_place_it_on_the_plate,pick_up_the_black_bowl_in_the_top_drawer_of_the_wooden_cabinet_and_place_it_on_the_plate,pick_up_the_black_bowl_on_the_stove_and_place_it_on_the_plate]'
    ;;
  counterfactual_cra_only_gate)
    EXP_NAME=RA-LOOP_spatial_counterfactual_cra_only_gate
    VARIANT_NAME=four_task_50step_k8_h220_fixed_l2_0p1_cra_only_matched_cal3_step5_warmstart
    OUTPUT_PATH="${PROJECT_ROOT}/outputs/ra_loop_spatial_counterfactual_cra_only_gate"
    N_STEPS=50
    SAVE_INTERVAL=10
    MODEL_LR=1e-5
    HEADER_LR=1e-5
    ...
    TASK_NAMES_OVERRIDE='[pick_up_the_black_bowl_next_to_the_plate_and_place_it_on_the_plate,pick_up_the_black_bowl_between_the_plate_and_the_ramekin_and_place_it_on_the_plate,pick_up_the_black_bowl_in_the_top_drawer_of_the_wooden_cabinet_and_place_it_on_the_plate,pick_up_the_black_bowl_on_the_stove_and_place_it_on_the_plate]'
    ;;
  counterfactual_soft_smoke)
    EXP_NAME=RA-LOOP_spatial_counterfactual_soft_smoke
    VARIANT_NAME=one_task_3step_k8_h220_fixed_l2_0p1_soft_cra_npc_cal1_step5_warmstart
    OUTPUT_PATH="${PROJECT_ROOT}/outputs/ra_loop_spatial_counterfactual_soft_smoke"
    N_STEPS=3
    SAVE_INTERVAL=9999
    MODEL_LR=1e-5
    HEADER_LR=1e-5
    ...
    NOMINAL_CALIBRATION_BATCHES=1
    TRAIN_SEED=30000
    PERTURB_SEED=20280720
    LORA_ADAPTOR_CKPT="${PILOT_STEP5_CKPT}"
    TASK_NAMES_OVERRIDE='[pick_up_the_black_bowl_in_the_top_drawer_of_the_wooden_cabinet_and_place_it_on_the_plate]'
    ;;
  counterfactual_soft_gate_seed10000)
    EXP_NAME=RA-LOOP_spatial_counterfactual_soft_gate_seed10000
    VARIANT_NAME=four_task_51step_k8_h220_fixed_l2_0p1_soft_cra_npc_cal3_step5_warmstart
    OUTPUT_PATH="${PROJECT_ROOT}/outputs/ra_loop_spatial_counterfactual_soft_gate_seed10000"
    N_STEPS=51
    SAVE_INTERVAL=10
    MODEL_LR=1e-5
    HEADER_LR=1e-5
    ...
    TASK_NAMES_OVERRIDE='[pick_up_the_black_bowl_next_to_the_plate_and_place_it_on_the_plate,pick_up_the_black_bowl_between_the_plate_and_the_ramekin_and_place_it_on_the_plate,pick_up_the_black_bowl_in_the_top_drawer_of_the_wooden_cabinet_and_place_it_on_the_plate,pick_up_the_black_bowl_on_the_stove_and_place_it_on_the_plate]'
    ;;
  counterfactual_soft_gate_seed20000)
    EXP_NAME=RA-LOOP_spatial_counterfactual_soft_gate_seed20000
    VARIANT_NAME=four_task_51step_k8_h220_fixed_l2_0p1_soft_cra_npc_cal3_step5_warmstart
    OUTPUT_PATH="${PROJECT_ROOT}/outputs/ra_loop_spatial_counterfactual_soft_gate_seed20000"
    N_STEPS=51
    SAVE_INTERVAL=10
    MODEL_LR=1e-5
    HEADER_LR=1e-5
