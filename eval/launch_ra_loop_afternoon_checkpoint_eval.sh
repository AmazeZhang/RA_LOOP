...
# Evaluate one saved afternoon checkpoint on all four matched Spatial tasks.
...
OUTPUT_ROOT="${PROJECT_ROOT}/logs/ra_loop_afternoon_checkpoint_eval_20260721"
...
echo "Starting afternoon checkpoint step=${STEP} GPU=${GPU_ID}: 4 tasks x 12 episodes"
for task_id in 0 1 2 3; do
